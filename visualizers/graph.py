...
with open("USDJPY/to_check.txt", "r") as file:
...
for i, line in enumerate(lines):
    ...
    in_filename_result = re.sub(r"\.csv$", "_result.csv", in_filename)
    data_result = np.loadtxt(in_filename_result, delimiter=",", unpack=True)
    plt.plot(data_result[0], data_result[1], color="red")
